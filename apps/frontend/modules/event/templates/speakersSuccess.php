<div>
  ...
  <div class="two columns">
    <section class="speakesr wide column">
      <h3>Speakers</h3>
        ...
        <ul class="users details extra">
          <?php foreach($event->getSpeakers() as $speaker) : ?>
            <li>
              ...
              <?php echo link_to('Remove', 'event_speaker_remove', array('sf_subject' => $event, 'username' => $speaker->getUsername()), array('class' => 'action remove', 'method' => 'post')) ?>
            </li>
          <?php endforeach ?>
        </ul>
