...
CREATE TABLE sf_guard_user_profile (id BIGINT AUTO_INCREMENT, description VARCHAR(255), website VARCHAR(255), image VARCHAR(255), icon VARCHAR(255), slug VARCHAR(255), created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, UNIQUE INDEX sf_guard_user_profile_sluggable_idx (slug), PRIMARY KEY(id)) ENGINE = INNODB;
