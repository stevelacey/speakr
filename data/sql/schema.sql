...
CREATE TABLE event (id BIGINT AUTO_INCREMENT, conference_id BIGINT NOT NULL, tagline VARCHAR(50), date DATETIME NOT NULL, location_id BIGINT NOT NULL, description VARCHAR(255) NOT NULL, url VARCHAR(255), image VARCHAR(255), icon VARCHAR(255), hashtag VARCHAR(20) NOT NULL, address VARCHAR(255) NOT NULL, postcode VARCHAR(8) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX conference_id_idx (conference_id), INDEX location_id_idx (location_id), PRIMARY KEY(id)) ENGINE = INNODB;
