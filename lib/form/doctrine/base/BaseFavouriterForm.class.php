...
/**
 * Favouriter form base class.
 *
 * @method Favouriter getObject() Returns the current form's model object
 *
 * @package    speakr
 * @subpackage form
 * @author     Steve Lacey
 ...
 */
abstract class BaseFavouriterForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('favouriter[%s]');
